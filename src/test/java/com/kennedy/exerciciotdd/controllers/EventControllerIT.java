package com.kennedy.exerciciotdd.controllers;
...
public class EventControllerIT {
	...
	public void updateShouldUpdateResourceWhenIdExists() throws Exception{
		...
		ResultActions result = mockMvc.perform(put("/events/{id}", existingId)
				.content(jsonBody)
	...
	public void updateShouldReturnNotFoundWhenIdDoesNotExist() throws Exception{
		...
		ResultActions result = mockMvc.perform(put("/events/{id}", nonExistingId)
				.content(jsonBody)
				.contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON));
